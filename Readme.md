...
| MOS FET | N-ch 電界効果トランジスタ | 駆動回路のスイッチング | [2SK4017](https://www.google.com/search?client=firefox-b-d&q=2SK4017)など | 連続2A以上流せて，オン抵抗が低いFETを選定  |
